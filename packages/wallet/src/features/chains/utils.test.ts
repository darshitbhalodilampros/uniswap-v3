...
describe(fromMoonpayNetwork, () => {
  it("handles supported chain", () => {
    ...
    expect(fromMoonpayNetwork(Chain.Arbitrum.toLowerCase())).toEqual(
      ChainId.ArbitrumOne
    );
    expect(fromMoonpayNetwork(Chain.Optimism.toLowerCase())).toEqual(
      ChainId.Optimism
    );
    expect(fromMoonpayNetwork(Chain.Polygon.toLowerCase())).toEqual(
      ChainId.Polygon
    );
...
describe(fromUniswapWebAppLink, () => {
  it("handles supported chain", () => {
    expect(fromUniswapWebAppLink(Chain.Ethereum.toLowerCase())).toEqual(
      ChainId.Mainnet
    );
    expect(fromUniswapWebAppLink(Chain.Arbitrum.toLowerCase())).toEqual(
      ChainId.ArbitrumOne
    );
    expect(fromUniswapWebAppLink(Chain.Optimism.toLowerCase())).toEqual(
      ChainId.Optimism
    );
    expect(fromUniswapWebAppLink(Chain.Polygon.toLowerCase())).toEqual(
      ChainId.Polygon
    );
  ...
  it("handle unsupported chain", () => {
    expect(() => fromUniswapWebAppLink("unkwnown")).toThrow(
      'Network "unkwnown" can not be mapped'
    );
  });
});
...
describe(toUniswapWebAppLink, () => {
  it("handles supported chain", () => {
    expect(toUniswapWebAppLink(ChainId.Mainnet)).toEqual(
      Chain.Ethereum.toLowerCase()
    );
    expect(toUniswapWebAppLink(ChainId.ArbitrumOne)).toEqual(
      Chain.Arbitrum.toLowerCase()
    );
    expect(toUniswapWebAppLink(ChainId.Optimism)).toEqual(
      Chain.Optimism.toLowerCase()
    );
    expect(toUniswapWebAppLink(ChainId.Polygon)).toEqual(
      Chain.Polygon.toLowerCase()
    );
    // TODO: add Base test once Chain includes Base (GQL reliant)
  });
