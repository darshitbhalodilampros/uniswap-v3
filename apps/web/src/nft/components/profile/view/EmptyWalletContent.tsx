...
const EMPTY_WALLET_CONTENT: {
  ...
  nft: {
    ...
    subtitle: (
      <Trans>Buy or transfer NFTs to this wallet to get started.</Trans>
    ),
    icon: <EmptyNftsIcon />,
  },
  token: {
    ...
    subtitle: (
      <Trans>Buy or transfer tokens to this wallet to get started.</Trans>
    ),
  ...
  pool: {
    ...
    subtitle: (
      <Trans>Open a new position or create a pool to get started.</Trans>
    ),
