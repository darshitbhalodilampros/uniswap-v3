    ...
    return [
      columnHelper.accessor((row) => row, {
        ...
        header: () => (
          <Cell
            minWidth={
              PoolTransactionColumnWidth[PoolTransactionColumn.Timestamp]
            }
          ...
          >
            <Row gap="4px">
              ...
              <HeaderSortText
                $active={sortState.sortBy === Transaction_OrderBy.Timestamp}
              >
                <Trans>Time</Trans>
              </HeaderSortText>
            </Row>
      ...
      columnHelper.accessor(
        (row) => {
          ...
          return (
            <ThemedText.BodyPrimary color={color}>
              {text}
      ...
      columnHelper.accessor((row) => row.amountUSD, {
        ...
        header: () => (
          <Cell
            minWidth={
              PoolTransactionColumnWidth[PoolTransactionColumn.FiatValue]
            }
      ...
      columnHelper.accessor(
        (row) =>
          row.pool.token0.id.toLowerCase() === token0?.address?.toLowerCase()
            ? row.amount0
            : row.amount1,
        {
          id: "input-amount",
          header: () => (
            <Cell
              loading={showLoadingSkeleton}
              minWidth={
                PoolTransactionColumnWidth[PoolTransactionColumn.InputAmount]
              }
              justifyContent="flex-end"
              grow
            >
              <ThemedText.BodyPrimary>{token0?.symbol}</ThemedText.BodyPrimary>
            </Cell>
          ),
            ...
            : row.amount0,
        {
          ...
          header: () => (
            <Cell
              loading={showLoadingSkeleton}
              minWidth={
                PoolTransactionColumnWidth[PoolTransactionColumn.OutputAmount]
              }
              justifyContent="flex-end"
              grow
            >
              <ThemedText.BodyPrimary>{token1?.symbol}</ThemedText.BodyPrimary>
            </Cell>
          ),
      ...
      columnHelper.accessor((row) => row.maker, {
        ...
        header: () => (
          <Cell
            minWidth={
              PoolTransactionColumnWidth[PoolTransactionColumn.MakerAddress]
            }
            justifyContent="flex-end"
            grow
          >
