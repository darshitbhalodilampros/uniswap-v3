      ...
      <div className="FooterMain">
        <div className="f-sec1">
          ...
          <div>
            ...
            <a
              href="https://symbiosis.finance/swap-and-bridge-mode"
              className="footerlink"
              target="_blank"
            >
            ...
            <a
              href="https://defillama.com/chain/Mode"
              className="footerlink"
              target="_blank"
            >
          ...
          <div>
            <h2>Social</h2>
            <a
              href="https://discord.gg/K9wMF5vWfN"
              className="footerlink"
              target="_blank"
            >
            ...
            <a
              href="https://twitter.com/Udonswap1"
              className="footerlink"
              target="_blank"
            >
